...
public class Multiavatar {
    func multiavatar(string: String, sansEnv _: String, ver _: String) -> String {
        ...
        for part in partsString {
            let partV = part.value[0 ..< 2]

            let theme = ThemeVersion(rawValue: part.value[2...])
...
//        }
    ...
    let themes: [String: [ThemeVersion: [PartType: [String]]]] = {
...
extension StringPartsCollection {
    //    mutating func insert(_ parts: [String [PartType: String]]) {
